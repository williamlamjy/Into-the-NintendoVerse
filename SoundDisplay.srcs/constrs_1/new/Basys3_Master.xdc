...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {OLED_cs}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OLED_cs}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {OLED_sdin}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OLED_sdin}]
##Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {JC[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JC[2]}]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {OLED_sclk}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OLED_sclk}]
##Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {OLED_dcn}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OLED_dcn}]
##Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {OLED_resn}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OLED_resn}]
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {OLED_vccen}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OLED_vccen}]
##Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {OLED_pmoden}]					
